...
-- Started on 2019-10-04 19:17:24
...
CREATE TABLE public.composizioni (
    codice_lavorazione character(15) NOT NULL,
...
CREATE TABLE public.lavorazioni (
    ...
    codice_lavorazione character(15) NOT NULL,
    codice_materiale character(4) NOT NULL,
...
CREATE TABLE public.materiali (
    codice_classe character(2) NOT NULL,
    codice_materiale character(6) NOT NULL,
    nome character varying(30) NOT NULL,
...
--
-- TOC entry 2780 (class 2606 OID 16565)
...
--
-- TOC entry 2782 (class 2606 OID 16573)
...
--
-- TOC entry 2774 (class 2606 OID 16832)
...
--
-- TOC entry 2809 (class 2606 OID 16648)
...
--
-- TOC entry 2803 (class 2606 OID 16833)
...
-- Completed on 2019-10-04 19:17:24
